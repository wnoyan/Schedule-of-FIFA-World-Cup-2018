...
int main()
{
    ...
    cout<<"\n\t\tEnter 1 For Match Schedules"<<endl;
    cout<<"\t\tEnter 2 For Teams Information"<<endl;
    cout<<"\t\tEnter 3 For Groups Information"<<endl;
    ...
    if(a == 1){
        cout<<"\n\t\tYou can show match schedules in 3 ways"<<endl;

        cout<<"\n\t\tEnter 1 to show the nth number match"<<endl;
        cout<<"\t\tEnter 2 to show date-wise matches"<<endl;
        cout<<"\t\tEnter 3 to show team-wise matches"<<endl;
        ...
        if(b == 1){
            ...
            int match_number;
            cout<<"\n\n\t\tEnter the match number you want to show!"<<endl;
            cout<<"\t\t";
            ...
            cout<<"\n\t\tEnter the team name to show the schedules"<<endl;
            cout<<"\t\t";
